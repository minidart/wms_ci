				...
				<div class="row">
					<div class="col-12">
						<div class="card card-info">
							...
							<!-- /.card-header -->
							<!-- form start -->
							<form class="form-horizontal" method="post" action="<?= base_url('index.php/partner/insert') ?>">
								<div class="card-body">
									<div class="form-group row">
										<label for="inputCode" class="col-sm-2 col-form-label">Jenis</label>
										<div class="col-sm-10">
											<input type="radio" class="form-check-inline" id="inputTypeTransporter" name="type" value="Transporter" required>
											<label for="inputCodeTransporter">Transporter</label>
											<br>
											<input type="radio" class="form-check-inline" id="inputTypeVendor" name="type" value="Vendor" required>
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="tel" class="form-control" id="inputPhone" placeholder="" name="phone_number">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="inputPhone" placeholder="" name="fax">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="email" class="form-control" id="inputPhone" placeholder="" name="email">
										</div>
									</div>
								</div>
								<!-- /.card-body -->
