					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">
									<a href="<?= base_url('index.php/partner/add') ?>">
										...
										<tr>
											...
											<td>
												<button
													...
													onclick="window.location.href = '<?= base_url('index.php/partner/edit/'.$partner->id) ?>'">
													Ubah
												</button>
												<button
													class="btn btn-danger"
													onclick="window.location.href = '<?= base_url('index.php/partner/delete/'.$partner->id) ?>'">
													Hapus
												</button>
											</td>
										</tr>
