					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">
									<a href="<?= base_url('index.php/unit/add') ?>">
										...
										<tr>
											...
											<td>
												<button
													...
													onclick="window.location.href = '<?= base_url('index.php/unit/edit/'.$unit->id) ?>'">
													Ubah
												</button>
												<button
													class="btn btn-danger"
													onclick="window.location.href = '<?= base_url('index.php/unit/delete/'.$unit->id) ?>'">
													Hapus
												</button>
											</td>
										</tr>
