				...
				<div class="row">
					<div class="col-12">
						<div class="card card-info">
							...
							<!-- /.card-header -->
							<!-- form start -->
							<form class="form-horizontal" method="post" action="<?= base_url('index.php/unit/update') ?>">
								...
								<div class="card-body">
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="inputCode" name="code" value="<?= $unit->code ?>" required>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="inputName" value="<?= $unit->name ?>" name="name" required>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="inputAddress" name="info" value="<?= $unit->info ?>" required>
										</div>
									</div>
								</div>
								<!-- /.card-body -->
